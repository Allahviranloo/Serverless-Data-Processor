...
# @app.blob_trigger(arg_name="client", path="input-files/{name}",
#                   connection="AzureWebJobsStorage")
# def BlobProcessor(client: blob.BlobClient):
#     logging.info(
...
@app.route(route="RetrieveData", auth_level=func.AuthLevel.FUNCTION)
def RetrieveData(req: func.HttpRequest) -> func.HttpResponse:
